...
function copyLogo() {
  const sourcePath = 'C:\\Users\\NEW TECH\\.gemini\\antigravity\\brain\\576cb173-e99f-41d1-a92a-af7b56065b02\\.user_uploaded\\media__1785410553771.png';
  ...
  if (fs.existsSync(sourcePath)) {
    ...
    console.log('Logo and favicon successfully copied to public/ and src/app/');
  } else {
