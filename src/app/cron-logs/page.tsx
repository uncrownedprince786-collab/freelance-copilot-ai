...
const st: Record<string, React.CSSProperties> = {
  ...
  statusBar: { display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 10, marginBottom: 16 },
  ...
  logBody: { display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 0, background: '#f9fafb' },
