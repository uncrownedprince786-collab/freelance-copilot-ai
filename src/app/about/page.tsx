...
export const metadata = {
  ...
  description: "Lead Hunter helps freelancers discover, evaluate, and act on better freelance opportunities using real job data.",
};
...
const FEATURES = [
  { icon: IconSearch, title: "Discover", desc: "Find relevant freelance opportunities from the available job data, filtered down to what matches your work." },
  { icon: IconShield, title: "Assess", desc: "Understand each job through its own signals: score, competition, budget, freshness, and client information." },
  { icon: IconCheck, title: "Act", desc: "Use the job details, analysis, and generated proposal workflow to decide what is worth pursuing." },
];

const WORKFLOW = [
  { icon: IconBriefcase, title: "Jobs", desc: "Collected listings" },
  { icon: IconShield, title: "Job Assessment", desc: "Per-job signals" },
  { icon: IconTrend, title: "Trends", desc: "Market view" },
  { icon: IconAgent, title: "Agent", desc: "Conversational help" },
  { icon: IconCheck, title: "Proposal", desc: "Generated to apply" },
];
      ...
      <div style={styles.shell}>
        ...
        <section style={styles.hero}>
          ...
          <p className="lh-body" style={styles.tagline}>
            Lead Hunter helps freelancers discover, evaluate, and act on better freelance opportunities using real
            job data from Upwork and Freelancer.
          </p>
        ...
        <section style={styles.section} className="lh-surface">
          ...
          <p className="lh-body" style={styles.body}>
            Every listing moves through the same pipeline so the result is a small set of opportunities with the
            reasoning visible, not another wall of listings to scan manually.
          </p>
        ...
        <section style={styles.section} className="lh-surface">
          ...
          <h2 style={styles.heading}>A clear path from listing to proposal.</h2>
        ...
        {/* Job-level intelligence */}
        <section style={styles.section} className="lh-surface">
          <div style={styles.kicker}>Job-Level Intelligence</div>
        ...
        <section style={styles.section} className="lh-surface">
          <div style={styles.kicker}>Market Trends</div>
        ...
        <section style={styles.section} className="lh-surface">
          ...
          <div style={styles.agentGrid}>
            ...
            <div style={styles.convWrap}>
              <div style={styles.userBubble}>Find me recent React jobs.</div>
